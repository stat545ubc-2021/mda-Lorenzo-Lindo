...
#### Plotting the distribution of the mean radius of nuclei present in the sample images in this dataset (variable = radius_mean)
cancer_sample %>% 
...
#### A boxplot of the frequency of different observations of the area_mean in either "M" malignant or "B" benign observations
cancer_sample %>% 
  group_by(diagnosis) %>% 
